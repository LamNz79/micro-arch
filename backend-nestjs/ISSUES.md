...
- [x] **API Documentation**: Integrate `@nestjs/swagger` to automatically generate OpenAPI documentation for both services.
- [x] **Health Checks**: Implement `@nestjs/terminus` for robust health checks (database connectivity, microservice availability) instead of simple static return values.
