...
- [x] **Configuration Validation**: Use `joi` or `zod` within `ConfigModule` to validate environment variables (e.g., `DATABASE_URL`, `PORT`, `INVENTORY_BASE_URL`) on application startup.
